...
function! MySetTitle()
    ...
    if &filetype == 'python'
        ...
        call append(line(".")+1,  "\"\"\"")
        call append(line(".")+2,  "\Copyright (C) 2016 Canux CHENG.")
        call append(line(".")+3,  "\All rights reserved.")
        call append(line(".")+4,  "")
        call append(line(".")+5,  "\LICENSE GNU General Public License v3.0.")
        call append(line(".")+6,  "")
        call append(line(".")+7,  "SUMMARY")
        call append(line(".")+8,  "")
        call append(line(".")+9,  "\:file: ".expand("%"))
        call append(line(".")+10,  "\:author: Canux CHENG canuxcheng@gmail.com")
        call append(line(".")+11,  "\:version: V1.0.0.0")
        call append(line(".")+12,  "\:since: ".strftime("%c"))
        call append(line(".")+13,  "")
        call append(line(".")+14,  "\DESCRIPTION:")
        call append(line(".")+15, "\"\"\"")
